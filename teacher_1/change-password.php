...
$sql ="SELECT TeachID FROM tblteacher WHERE TeachID=:sid and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update tblteacher set Password=:newpassword where TeachID=:sid";
...
<html lang="en">
  <head>
    ...
    <title>Online Student Information Management System|| Teacher Change Password</title>
    <!-- plugins:css -->
